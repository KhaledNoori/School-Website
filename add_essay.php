...
if (isset($_POST["save"])) {
  ...
  move_uploaded_file($_FILES['description']['tmp_name'], $pdfPath);


  $sql = "INSERT INTO essay (title, publisher,publication_year, image, description) VALUES ('$title', '$publisher', '$year', '$image', '$pdf')";
            ...
            <div class="row">
              ...
              <div class="col-xl-12">
                ...
                <div class="form-container">
                  <h3 style="text-align: center">ثبت مقاله جدید</h3>
                  <form action="#" method="post" enctype="multipart/form-data">
