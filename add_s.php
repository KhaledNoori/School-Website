...
if(isset($_POST["save"])){
  ...
  $num_student = $_POST['students'];
  $num_teacher = $_POST['teachers'];
  $num_class = $_POST['classess'];
  $num_branch = $_POST['branches'];

  $sql = "INSERT INTO  statistics (`student`,`teacher`,`classes`,`branch`) VALUES ('$num_student', 
  '$num_teacher','$num_class','$num_branch')";
...
$insert_query = mysqli_query($GLOBALS['DB'], $sql);
  if($insert_query){
    ...
    header("location:list_of_statistics.php");
  }else{
    echo " data inserted faild";
...
<body>
  <section x-data="toggleSidebar">
    ...
    <section class="main" :class="open || 'active'">
      ...
      <h3 style="text-align: center;">ثبت آمار جدید</h3>
        <div class="row">
          <div class="col-12">
            <div class="row">
              <div class="col-xl-12">
              <?php
                ...
                <div class="form-container">
                  <form action="#" method="POST">
                    <h2>ثبت آمار</h2>
                    <label for="student">شاگردان:</label>
                    <input type="number" id="student" name="students" required>

                    <label for="teachers">آموزگار:</label>
                    <input type="number" id="teachers" name="teachers" required>

                    <label for="class">صنف آموزشی :</label>
                    <input type="number" id="classess" name="classess" required>

                    <label for="branch-type"> نمایندگی ها :</label>
                    <input type="number" id="branch-type" name="branches" required>

                    <button type="submit" name="save">ارسال</button>
                  </form>
                </div>
              </div>
            </div>
