...
if (isset($_POST["save"])) {
    ...
    // Same as above, but for the "class" field.
    ...
    $query = "INSERT INTO topstudent (name, class, position, image, description) VALUES ('$student_name', '$student_class', '$student_position', '$image', '$pdf')";
    $insert_query = mysqli_query($GLOBALS['DB'], $query);
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="form-container">
                                    <h3 style="text-align: center;">ثبت شاگرد جدید</h3>
                                    <form action="#" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="description" name="pdf" required accept=".pdf">
                                        </div>
