...
if (isset($_GET['advertise_id'])) {

  $advertise_id = $_GET['advertise_id'];

  $sql = " delete from advertise where id='$advertise_id'";

  $query = mysqli_query($GLOBALS['DB'], $sql);

  if ($query) {

    header("location:list_of_advertises.php?deleted=1");
  }
}
...
<body>
            ...
            <div class="row">
              <div class="col-xl-12">
                ...
                <div class="table-container">
                  <div class="text-center m-0 p-2 " style="background-color: #5cb85c; color:#fff ;  border-bottom: 2px solid #fff;">
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      while ($advertise = mysqli_fetch_assoc($advertise_query)) {
                      ?>
                        <tr>
                          <td>
                            <?php echo $advertise["id"]; ?>
                          </td>
                          <td>
                            <?php echo $advertise["title"]; ?>
                          <td>
                            <?php echo $advertise["description"]; ?>
                          </td>
                          </td>
                          <td>
                            <?php echo $advertise["image"]; ?>
                          </td>

                          <td class="operations">


                            <a href="list_of_advertises.php?advertise_id=<?php echo $advertise["id"]; ?>">
                              <button style=color:red; id="sample_editable_1_new" class="btn red">
                                🗑️ <i class="fa fa-remove" name="remove"></i>
                              </button>
                            </a>

                            <a href="edit_advertise.php?edit_advertise_id=<?php echo $advertise["id"]; ?>">
  ...
  <!-- js file -->
  <script src=<?php echo "assets/js/javaScript.js" ?> defer></script>
