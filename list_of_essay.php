...
if (isset($_GET['essay_id'])) {
  ...
  $sql = " delete from essay where id='$essay_id'";

  $query = mysqli_query($GLOBALS['DB'], $sql);

  if ($query) {

    header("location:list_of_essay.php?deleted=1");
  }
}
?>
          ...
          <div class="col-12">
            <div class="row">
              ...
              <?php
                ...
                <div class="text-center m-0 p-2 " style="background-color: #5cb85c; color:#fff ;  border-bottom: 2px solid #fff;"><h3>لیست مقالات</h3></div>
                  <table>
                    ...
                    <tbody>
                      ...
                      while ($essay = mysqli_fetch_assoc($essay_query)) {
                      ...
                      ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo $essay["publisher"]; ?>
                          </td>
                          <td>
                            <?php echo $essay["publication_year"]; ?>
                          </td>
                          <td>
                            <?php echo $essay["image"]; ?>
                          </td>
                          <td>
                            <?php echo $essay["description"]; ?>
                          </td>
                          <td class="operations">

                            <a href="list_of_essay.php?essay_id=<?php echo $essay["id"]; ?>">
                              <button style=color:red; id="sample_editable_1_new" class="btn red">
                                🗑️ <i class="fa fa-remove" name="remove"></i>
                              </button>
                            </a>

                            <a href="edit_essay.php?edit_essay_id=<?php echo $essay["id"]; ?>">
