...
if (isset($_GET['statistic_id'])) {

  $statistic_id = $_GET['statistic_id'];

  $sql = " delete from statistics where id='$statistic_id'";

  $query = mysqli_query($GLOBALS['DB'], $sql);

  if ($query) {

    header("location:list_of_statistics.php?deleted=1");
  }
}
?>
...
<head>
  ...
  <style>
    ...
    .edit-icon:hover {
      color: #007bff;
      /* رنگ آیکون ویرایش هنگام هاور */
    }

    .delete-icon:hover {
      color: #dc3545;
      /* رنگ آیکون حذف هنگام هاور */
    }
          ...
          <div class="col-12">
            <div class="row">
              ...
              <?php
                ...
                <div class="text-center m-0 p-2 " style="background-color: #5cb85c; color:#fff ;  border-bottom: 2px solid #fff;"><h3>لیست آمار</h3></div>
                  <table>
                    ...
                    <tbody>
                      ...
                      $st_query = mysqli_query($GLOBALS['DB'], $sql);
                      while ($statistic = mysqli_fetch_assoc($st_query)) {
                      ?>
                        <tr>
                          <td><?php echo $statistic['id']   ?></td>

                          <td><?php echo $statistic['student']   ?></td>
                          <td> <?php echo $statistic['teacher']   ?></td>
                          <td><?php echo $statistic['classes']   ?></td>
                          <td><?php echo $statistic['branch']   ?></td>
                          <td class="operations">


                            <a href="list_of_statistics.php?statistic_id=<?php echo $statistic["id"]; ?>">
                              <button style=color:red; id="sample_editable_1_new" class="btn red">
                                🗑️ <i class="fa fa-remove" name="remove"></i>
                              </button>
                            </a>

                            <a href="edit_statistic.php?edit_statistic_id=<?php echo $statistic["id"]; ?>">
                              <button style=color:green id="sample_editable_1_new" class="btn green">
                                ✏️<i class="fa fa_edit" name="edit"></i>
                              </button>
                            </a>
