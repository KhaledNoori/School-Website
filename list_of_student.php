...
if (isset($_GET['student_id'])) {
  ...
  $sql = " delete from topstudent where id='$student_id'";
            ...
            <div class="row">
              <div class="col-xl-12">
                ...
                <div class="table-container">
                  <div class="text-center m-0 p-2 " style="background-color: #5cb85c; color:#fff ;  border-bottom: 2px solid #fff;"><h3>لیست شاگردان</h3></div>
                  <table>
                    <thead>
                      <tr>
                        <th>شماره</th>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="operations">
                            ...
                            <a href="list_of_student.php?student_id=<?php echo $student["id"]; ?>">
                              <button style=color:red; id="sample_editable_1_new" class="btn red">
                                🗑️ <i class="fa fa-remove" name="remove"></i>
                              </button>
                            </a>

                            <a href="edit_student.php?edit_student_id=<?php echo $student["id"]; ?>">
